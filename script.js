...
const MENU = {
  ...
  burgers: [
    { icon: '🍔', name: 'Classic Burger',     price: 7.90, desc: 'Μοσχαρίσιο μπιφτέκι 200γρ, τσένταρ, μαρούλι, ντομάτα και σπιτική σος.', ing: ['Μοσχάρι','Τσένταρ','Μαρούλι','Ντομάτα','Σπιτική σος'] },
    { icon: '🥓', name: 'Bacon Lover',         price: 8.90, desc: 'Με τραγανό μπέικον, καραμελωμένο κρεμμύδι και bbq σος.', ing: ['Μπέικον','Κρεμμύδι','BBQ','Τσένταρ'] },
    { icon: '🍄', name: 'Mushroom Swiss',     price: 8.50, desc: 'Με φρέσκα μανιτάρια σοτέ και τυρί ελβετικό.', ing: ['Μανιτάρια','Τυρί ελβετικό','Μαρούλι'] },
    { icon: '🐔', name: 'Chicken Burger',      price: 7.50, desc: 'Φιλέτο κοτόπουλο πανέ, αυτόχθονη σος και ραπανάκι.', ing: ['Κοτόπουλο','Σος γιαουρτιού','Ραπανάκι','Μαρούλι'] },
    { icon: '🌱', name: 'Veggie Burger',       price: 7.00, desc: 'Μπιφτέκι λαχανικών με αβοκάντο, ντομάτα και χούμους.', ing: ['Λαχανικά','Αβοκάντο','Χούμους','Ντομάτα'] },
    { icon: '🔥', name: 'Spicy Mexican',      price: 9.50, desc: 'Διπλό μπιφτέκι, jalapeños, πικάντικη σος και guacamole.', ing: ['Διπλό μπιφτέκι','Jalapeños','Guacamole','Πικάντικη σος'] },
  ],
  ...
  sticks: [
    ...
    { icon: '🥙', name: 'Πίτα Καλαμάκι χοιρινός', price: 3.50, desc: 'Πίτα Καλαμάκι χοιρινό με πατάτες, ντομάτα, κρεμμύδι και τζατζίκι.', ing: ['Γύρος','Πατάτες','Ντομάτα','Τζατζίκι'] },
  ...
  pasta: [
    { icon: '🍝', name: 'Καρμπονάρα',          price: 8.50, desc: 'Αυθεντική ιταλική με γκουαντσιάλε, αυγό, πεκορίνο και πιπέρι.', ing: ['Γκουαντσιάλε','Αυγό','Πεκορίνο','Πιπέρι'] },
    { icon: '🍝', name: 'Μπολονέζ',            price: 8.00, desc: 'Σπιτική σάλτσα κιμά που σιγοβράζει για ώρες.', ing: ['Κιμάς','Ντομάτα','Καρότο','Σέλινο'] },
    { icon: '🍝', name: 'Πένες αραμπιάτα',     price: 7.50, desc: 'Πικάντικη σάλτσα ντομάτας με σκόρδο και κόκκινη πιπεριά.', ing: ['Ντομάτα','Σκόρδο','Καυτερή πιπεριά'] },
    { icon: '🦐', name: 'Λιγκουίνι θαλασσινών',price: 11.50, desc: 'Λιγκουίνι με γαρίδες, μύδια, καλαμάρι και λευκό κρασί.', ing: ['Γαρίδες','Μύδια','Καλαμάρι','Λευκό κρασί'] },
    { icon: '🌿', name: 'Πέστο',                price: 7.50, desc: 'Σπιτικό πέστο βασιλικού με κουκουνάρι και παρμεζάνα.', ing: ['Βασιλικός','Κουκουνάρι','Παρμεζάνα'] },
    { icon: '🧄', name: 'Aglio e Olio',          price: 6.50, desc: 'Σπαγγέτι με λάδι, σκόρδο και πεπερόνι.', ing: ['Σκόρδο','Ελαιόλαδο','Πεπερόνι'] },
  ],
